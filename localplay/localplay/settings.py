"""
Django settings for localplay project.
...
ASGI_APPLICATION = 'localplay.asgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
		'localplay.authenticate.CustomJWTAuthentication'
