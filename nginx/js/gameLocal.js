...
//	// console.log("Player 2 data", player2Data);
	...
	player1 = {
		name: data.player1_tmp_username,
		score: 0,
	}

	player2 = {
		name: data.player2_tmp_username,
		score: 0,
	}
...
function handleDraw(event) {
	...
	drawBall(ball);
	updateScore();
	//sendPaddleMovement(); // needs to be called only once via setInterval -> moved to init()
}
...
//}
//
//const throttledDispatchEvent = throttle((direction, paddle) => {
...
export async function init(data) {
	...
	setInterval(sendPaddleMovement, 16); // 60 FPS
}
