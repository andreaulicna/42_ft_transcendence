const translations = {
	en: {
		...
		t_requestSentError_header: "Friend Request Error",
	...
	cs: {
		...
		language: "Jazyk",
		// LOGIN
		usernamePlaceholder: "Tvoje uživatelské jméno",
		...
		// DASHBOARD
		play: "Hraj",
		modeLocal: "Místní hráč",
		modeRemote: "Vzdálený hráč",
		modeAI: "AI hráč",
		modeTournamentLocal: "Místní turnaj",
		...
		// LOCAL PLAY
		localPlayer1TmpUsername: "Přezdívka hráče 1",
		localPlayer2TmpUsername: "Přezdívka hráče 2",
		localPlayCreate: "Vytvoř zápas",
		localPlayer1TmpUsernamePlaceholder: "Vlož přezdívku pro hráče 1",
		localPlayer2TmpUsernamePlaceholder: "Vlož přezdívku pro hráče 2",
		// NOTIFICATIONS
		...
		t_uniqueNames_message: "Hráči musí mít jedinečná jména.",
		...
		t_matchCreateLocal_header: "Chyba při vytváření místního zápasu",
		t_rematchCreateLocal_header: "Chyba při vytváření místní odvety",
		t_requestAccept_header: "Žádost o přátelství přijata",
		t_requestAccept_message: "Přijal jsi žádost o přátelství.",
		t_requestAcceptError_header: "Chyba při přijímání žádosti o přátelství",
		t_requestReject_header: "Žádost o přátelství odmítnuta",
		t_requestReject_message: "Odmítl jsi žádost o přátelství.",
		...
		t_requestSentError_header: "Chyba při žádosti o přátelství.",
		t_nameChange_header: "Změna uživatelského jména úspěšná",
		t_nameChange_message: "Aktualizoval jsi své uživatelské jméno.",
		...
		t_selectFileError_message: "Vyber soubor.",
	...
	sk: {
		...
		language: "Jazyk",
		// LOGIN
		usernamePlaceholder: "Tvoje užívateľské meno",
		passwordPlaceholder: "Tvoje heslo",
		...
		modeAI: "AI hráč",
		modeTournamentLocal: "Miestny turnaj",
		modeTournamentRemote: "Online turnaj",
		viewProfile: "Profil",
		logout: "Odhlásiť sa",
		// SEARCHING FOR GAME
		...
		addFriendPlaceholder: "Vlož meno priateľa",
		add: "Pridať",
		...
		// LOCAL PLAY
		localPlayer1TmpUsername: "Užívateľské meno hráča 1",
		localPlayer2TmpUsername: "Užívateľské meno hráča 2",
		localPlayCreate: "Vytvor zápas",
		localPlayer1TmpUsernamePlaceholder: "Zadaj uživateľske meno pre hráča 1",
		localPlayer2TmpUsernamePlaceholder: "Zadaj uživateľske meno pre hráča 2",
		// NOTIFICATIONS
		...
		t_matchCreateLocal_header: "Chyba pri vytváraní miestneho zápasu",
		t_rematchCreateLocal_header: "Chyba pri vytváraní miestne odvety",
		t_requestAccept_header: "Žiadosť o priateľstvo prijatá",
		t_requestAccept_message: "Prijal si žiadosť o priateľstvo.",
		...
		t_requestReject_message: "Odmietl si žiadosť o priateľstvo.",
		...
		t_requestSentError_header: "Chyba pri žiadosti o priateľstvo.",
		t_nameChange_header: "Zmena používateľského mena úspešná",
		t_nameChange_message: "Aktualizoval si svoje užívateľské meno.",
		...
		t_selectFileError_header: "Chyba",
		t_selectFileError_message: "Vyber súbor.",
		t_imageDimensionsError_header: "Chyba",
