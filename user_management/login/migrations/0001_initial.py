    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to=login.models.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournament_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='login.tournament')),
            ],
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('tournament_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='login.tournament')),
            ],
        ),
    ]
